...
本文檔記錄概念股篩選系統 CI/CD 流程中需要手動配置和完成的項目。雖然基礎架構已經建立，但實際的部署邏輯、監控告警等還需要根據具體環境進行配置。
...
- [x] `.github/workflows/dev-deploy.yml`
- [x] `.github/workflows/dev-quick-deploy.yml`
- [x] `.github/workflows/dev-monitoring.yml`
